...
const menuItems = [
    ...
    { id: 'PRODUCT_HISTORY', label: 'Historial Prod.', show: checkPermission('PRODUCTS', 'view.products'), icon: (
    ...
    { id: 'EXPENSES', label: 'Egresos', show: true, icon: (
    ...
    { id: 'ROL', label: 'Configuracion Roles', show: checkPermission('ROL', 'view.rol'), icon: (
