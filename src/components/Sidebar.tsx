...
const menuItems = [
    ...
    { id: 'PRODUCT_HISTORY', label: 'Historial Prod.', show: checkPermission('REPORTS', 'view.reports'), icon: (
    ...
    { id: 'FINANCE', label: 'Finanzas', show: checkPermission('REPORTS', 'view.reports'), icon: (
    ...
    { id: 'EXPENSES', label: 'Egresos', show: checkPermission('EXPENSES', 'view.expenses'), icon: (
        <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-5.94-2.28m5.94 2.28l-2.28 5.941" /></svg>
      ) },
    ...
    { id: 'ROL', label: 'Configuracion Roles', show: checkPermission('ROLES', 'view.roles'), icon: (
